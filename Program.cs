...
namespace SFA.DAS.Encoder
{
    class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            Parser.Default.ParseArguments<DecodeCommandLine, EncodeCommandLine, ListCommandLine, PairCommandLine>(args)
                ...
                .WithParsed<PairCommandLine>(Run<PairCommandLine, PairCommand>)
